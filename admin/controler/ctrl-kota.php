<?php
    class controler{
        ...
        function edit(){
            ...
            $query = mysql_db_query($db,"UPDATE $this->table_name SET kota = '$data' WHERE $this->primary_key = $id",$dbconn); 
            // perhatikan field yang di SET  di atas (karena di sini controler untuk kategory jadi field yang di set kota) harus di rubah di sini
    ...
    $controler->setTableIdentity("kota","id_kota");
    $controler->setConnection("../../setting/conn.php");
    $controler->setViewHeader("data-kota.php");
