<?php
    class controler{
        ...
        function edit(){
            ...
            $query = mysql_db_query($db,"UPDATE $this->table_name SET provinsi = '$data' WHERE $this->primary_key = $id",$dbconn); 
            // perhatikan field yang di SET  di atas (karena di sini controler untuk kategory jadi field yang di set provinsi) harus di rubah di sini
    ...
    $controler->setTableIdentity("provinsi","id_provinsi");
    $controler->setConnection("../../setting/conn.php");
    $controler->setViewHeader("data-provinsi.php");
