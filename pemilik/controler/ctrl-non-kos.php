<?php
    ...
    class controler{
        ...
        function add(){
            ...
            if($pics == ""){
                ...
                $uploadDir = "../../pics/bangunan/non-kos/";
            ...
            $str = "INSERT INTO $this->table_name VALUES (NULL, '$kategori', '$id_pemilik', '$nama', '$alamat', '$luas', '$jml_lantai', '$deskripsi', '$harga', '$air', '$listrik', '$id_kota', '$x', '$y', '$foto', '$video')";
        ...
        function edit(){
            ...
            $query = mysql_db_query($db,"UPDATE $this->table_name SET kontrakan = '$data' WHERE $this->primary_key = $id",$dbconn); 
            // perhatikan field yang di SET  di atas (karena di sini controler untuk kategory jadi field yang di set kontrakan) harus di rubah di sini
    ...
    $controler->setTableIdentity("kontrakan","id_kontrakan");
